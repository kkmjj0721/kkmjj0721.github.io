...
- global_background_layer_release_2026_06_13: `src/layouts/BaseLayout.astro` now mounts a shared fixed video background layer for all pages; light theme uses `/images/backgrounds/tomori.mp4`, dark theme uses `/images/backgrounds/友利奈绪动态壁纸.mp4`, and `src/components/home/HomeDashboard.astro` no longer carries the homepage-only full-screen background to avoid double loading
